  ...
  <n-form ref="formRef" :model="formValue" label-placement="top">
    <div class="network-tab">
      <n-space vertical size="large">
        ...
        <div>
          <n-h3 prefix="bar">主机与域名</n-h3>

          <n-form-item label="主机名 (Hostname)">
            <n-input v-model:value="formValue.hostname" placeholder="例如: mycontainer" />
            <template #feedback>
              <n-text depth="3" style="font-size: 12px"> 设置容器的主机名 </n-text>
            </template>
          </n-form-item>

          <n-form-item label="域名 (Domain Name)">
            <n-input v-model:value="formValue.domainname" placeholder="例如: example.com" />
            <template #feedback>
              <n-text depth="3" style="font-size: 12px"> 设置容器的域名 </n-text>
            </template>
          </n-form-item>
        </div>
